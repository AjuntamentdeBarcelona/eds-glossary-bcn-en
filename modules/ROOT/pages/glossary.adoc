...
The http://ajuntament.barcelona.cat/imi/en[Municipal Institute of Information Technology (IMI)] is a local independent Barcelona City Council body that was set up in 1990 to provide Barcelona City Council and the public companies under its wing with all their Information and Communication Technology Services.
