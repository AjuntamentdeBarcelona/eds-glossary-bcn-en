...
:_public_repo_url: https://github.com/AjuntamentdeBarcelona/eds-glossary-bcn-en
//
// MANDATORY.
:_url: https://ethical-digital-standards-bcn.netlify.com/glossary/
//
// MANDATORY. Title of the document. In web format, it appears as a heading of
// level 1. In PDF format, it appears in a title page.
:_title: Glossary for the Ethical Digital Standards
//
...
:_summary: This glossary includes a list of key terms used in the documents that form the Ethical Digital Standards of the Barcelona City Council.
//
// MANDATORY. Comma-separated list of terms to help classifying and searching
// the document. In web format, this terms are integrated as SEO enabling
// metadata. In PDF format, they are shown near the other metadata.
:keywords: ethical digital standards, technology rights, barcelona, city council, glossary
//
